...
show_help() {
    ...
    echo "  LOCAL_DIR         Base directory for checkpoints (default: ./checkpoints/)"
    ...
    echo ""
    echo "Examples:"
    echo "  $0                                        # instruction_and_robust_pi05 -> ./checkpoints/instruction_and_robust_pi05/"
    echo "  $0 manipulation_pi05                      # manipulation_pi05 -> ./checkpoints/manipulation_pi05/"
